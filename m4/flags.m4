...
# SING_SHOW_FLAGS([checking flags....])
 ...
 if test "x${ENABLE_OPTIMIZATION}" != xno; then
  OPTFLAGS="-O3 -Wno-unused-function -Wno-trigraphs -Wno-unused-parameter -Wno-unused-variable -fomit-frame-pointer -fwrapv -fvisibility=default -finline-functions -fno-rtti -fno-threadsafe-statics -fno-enforce-eh-specs -fconserve-space -funroll-loops"
  #  -O3 - crashes gcc???!!!
  # -fpermissive
  AC_LANG_PUSH([C])
